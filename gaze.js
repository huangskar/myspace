...
//Hack: Some folders maybe generated during building process, so we create a black list to ignore these
//folders for watching
function isDirInBlackList(dir){
    var list = ["ResourcesZip", "installation","Package","Resources","Debug","Release"],
        result = false;
    list.forEach(function (item) {
        if (dir.indexOf(item) != -1) {
            result = true;
        }
    })
    return result;
